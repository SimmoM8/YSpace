...
SELECT 1, 'ADMIN', 'Nova', 'Commander', 'admin@yspace.com', '$2b$10$eqTkRhFBIZ28kgsS89WQWe9zev0YkuRiyLVcYb8fYKVC0b597Vw0C', '2026-01-01 10:00:00', '2026-01-01 10:00:00'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 1);

INSERT INTO users (id, role, first_name, last_name, email, password, created_at, updated_at)
SELECT 2, 'SPACE_TOURIST', 'Luna', 'Park', 'luna.park@yspace.com', '$2b$10$C7awBDjCKTTqRqbjqlgo/OOoB8dKeSkTeEvExvcJvK6INQSk34Ili', '2026-01-02 11:00:00', '2026-01-02 11:00:00'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE id = 2);

INSERT INTO users (id, role, first_name, last_name, email, password, created_at, updated_at)
SELECT 3, 'SPACE_TOURIST', 'Orion', 'Vale', 'orion.vale@yspace.com', '$2b$10$C7awBDjCKTTqRqbjqlgo/OOoB8dKeSkTeEvExvcJvK6INQSk34Ili', '2026-01-03 12:00:00', '2026-01-03 12:00:00'
...
SELECT
    ...
    '$2b$10$C7awBDjCKTTqRqbjqlgo/OOoB8dKeSkTeEvExvcJvK6INQSk34Ili',
